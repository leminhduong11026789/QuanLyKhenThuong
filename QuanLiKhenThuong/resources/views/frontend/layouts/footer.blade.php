	...
	<div class="col-sm-12 box-footer">
		...
		<div class="col-sm-8 col-sm-offset-2 sm-left-margin">
			...
			<div class="col-sm-12 footer-contact">
				<div class="col-sm-6">
					<input id="customer_full_name" type="text" name="" value="" placeholder="Họ tên">
					<input id="customer_phone_number" type="text" name="" value="" placeholder="Số điện thoại">
					<input id="customer_gmail" type="text" name="" value="" placeholder="Gmail">
				</div>
				<div class="col-sm-6">
					<textarea class="form-control" rows="3" placeholder="Nội dung"></textarea>
					<button id="customer_footer" type="" class="pull-right">GỬI</button>
				</div>
			</div>
		</div>
